...
class MxCheckBoxGroup extends StatefulWidget {
  const MxCheckBoxGroup({
    Key? key,
  ...
  @override
  State<MxCheckBoxGroup> createState() => _MxCheckBoxGroupState();
}

class _MxCheckBoxGroupState extends State<MxCheckBoxGroup> {
  ...
  @override
  void didUpdateWidget(covariant MxCheckBoxGroup oldWidget) {
